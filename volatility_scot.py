...
if __name__ == '__main__':
    ...
    parser.add_argument('--radius', type=float, default=0.2, help='Wasserstein ball radius')
    ...
    for scene in range(n_runs):
        ...
        f = mv_obj(weight_init=torch.ones(n_stock)/n_stock, mean_init=torch.ones(1), risk_aversion=risk_aver).to(device)
    ...
    sub_folder = 'mv_causal_radi_{}_risk_{}'.format(args.causal, risk_aver)
